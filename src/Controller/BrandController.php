...
class BrandController extends AbstractController
{
    ...
    #[Route('/statistics', name: 'app_brand_statistics', methods: ['GET'])]
    public function statistics(BrandRepository $brandRepository): Response
    {
        $brandsWithCount = $brandRepository->getBrandsWithArticleCount();
        
        return $this->render('brand/statistics.html.twig', [
